...
final class JSONOutputPrinter extends StreamOutputPrinter
{
    ...
    /**
     * @param array<string, string|int|null> $exerciseAttributes
     */
    ...
    /**
     * @param array<string, string|int|null> $suiteAttributes
     */
    ...
    /**
     * @param array<string, string|int|null> $featureAttributes
     */
